function About() {
    return (
        <section id='about' className="my-10 scroll-mt-[96px] mx-auto w-[95%] md:w-auto container rounded-[50px] bg-neutral p-8">
            <div className="text-center md:w-[75%] lg:w-[50%] mx-auto">
                <h2 className="mb-5 text-3xl text-[#1EB854] font-bold">About Me</h2>
                <p className="mb-5 text-base ">As a self-taught frontend developer, I have spent the past year passionately learning and perfecting my skills. My background in teaching and creating courses brings a unique perspective to my projects, and I am always striving to make my sites engaging and user-friendly. 
                <br/><br/>

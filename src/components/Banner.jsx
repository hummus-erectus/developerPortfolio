...
function Banner() {
    return (
        <section id='about' className="mt-20 scroll-mt-[96px] md:mt-24 mx-auto w-[95%] md:w-auto container grid items-center rounded-[50px] bg-neutral md:grid-cols-2 p-8">
